    ...
    <div class="container mx-auto py-6">
        ...
        <form action="{{ route('admin.projects.update', $project) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="mb-4">
                ...
                <input type="text" name="title" class="form-input w-full" value="{{ old('title', $project->title) }}"
                    required>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="checkbox" name="active" value="1"
                    {{ old('active', $project->active) ? 'checked' : '' }}> Sim
            </div>
